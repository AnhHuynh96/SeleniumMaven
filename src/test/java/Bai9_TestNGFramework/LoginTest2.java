...
public class LoginTest2 {
    ...
    public void testAnhTesterBlog() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@placeholder='Tìm kiếm khóa học . . .']")).sendKeys("selenium");
        driver.findElement(By.xpath("//input[@placeholder='Tìm kiếm khóa học . . .']")).sendKeys(Keys.ENTER);
        Thread.sleep(2000);
    }
